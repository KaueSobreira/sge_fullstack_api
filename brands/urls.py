...
urlpatterns = [
    ...
    path('api/v1/brands/', views.BrandCreateListViewAPIView.as_view(), name='brand-create-list-api-view'),
    path('api/v1/brands/<int:pk>/', views.BrandDetailRetrieveDeleteViewAPIView.as_view(), name='brand-detail-retrieve-delete-api-view'),
]